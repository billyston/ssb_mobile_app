...
class FlexySusuAccountDetails extends StatefulWidget {
  final String resourceId;
  const FlexySusuAccountDetails({ required this.resourceId, super.key});

  @override
  State<FlexySusuAccountDetails> createState() => _FlexySusuAccountDetailsState();
}

class _FlexySusuAccountDetailsState extends State<FlexySusuAccountDetails> {
  ...
  FlexySusuAccount? susuAccount;
  Data? accountData;

  Future<FlexySusuAccount?> getAccountDetails() async{
    setState(() {
      dataLoaded = false;
      errorOccurred = false;
    });
    try {
      susuAccount = await ApiService().getFlexySusuAccount(token, widget.resourceId).timeout(const Duration(seconds: 90));
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      '${accountData!.included.currency.attributes.currency} ${accountData!.attributes.minAmount}',
                      style: TextStyle(
                          color: Colors.white,
                          fontSize: 22.sp,
                          fontWeight: FontWeight.w700),
