...
import '../../components/dialogs/pin_dialog.dart';
import '../../components/error_container.dart';
import '../../components/loading_dialog.dart';
import '../../utils/utils.dart';
import '../transactions/transaction_history_screen.dart';

class GoalGetterSusuAccountDetails extends StatefulWidget {
  final String resourceId;
  const GoalGetterSusuAccountDetails({required this.resourceId, super.key});

  @override
  State<GoalGetterSusuAccountDetails> createState() => _GoalGetterSusuAccountDetailsState();
}

class _GoalGetterSusuAccountDetailsState extends State<GoalGetterSusuAccountDetails> {
  ...
  GoalGetterSusuAccount? susuAccount;
  Data? accountData;

  Future<GoalGetterSusuAccount?> getAccountDetails() async{
    setState(() {
      dataLoaded = false;
      errorOccurred = false;
    });
    try {
      susuAccount = await ApiService().getGoalGetterSusuAccount(token, widget.resourceId).timeout(const Duration(seconds: 90));
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      '${accountData!.included.currency.attributes.currency} ${accountData!.attributes.targetAmount}',
                      style: TextStyle(
                          color: Colors.white,
                          fontSize: 22.sp,
                          fontWeight: FontWeight.w700),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          accountData!.attributes.startDate.toString().substring(0,10),
                          style: TextStyle(
                              color: Colors.white,
                              fontSize: 15.sp,
                              fontWeight: FontWeight.w700),
                        ...
                        Text(
                          accountData!.attributes.endDate.toString().substring(0,10),
                          style: TextStyle(
                              color: Colors.white,
                              fontSize: 15.sp,
                              fontWeight: FontWeight.w700),
