...
import 'package:susubox/screens/transactions/transaction_history_screen.dart';
...
class BizSusuAccountDetails extends StatefulWidget {
  final String resourceId;
  const BizSusuAccountDetails({required this.resourceId, super.key});

  @override
  State<BizSusuAccountDetails> createState() => _BizSusuAccountDetailsState();
}

class _BizSusuAccountDetailsState extends State<BizSusuAccountDetails> {
  ...
  BizSusuAccount? susuAccount;
  Data? accountData;

  Future<BizSusuAccount?> getAccountDetails() async{
    setState(() {
      dataLoaded = false;
      errorOccurred = false;
    });
    try {
      susuAccount = await ApiService().getBizSusuAccount(token, widget.resourceId).timeout(const Duration(seconds: 90));
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(accountData!.attributes.businessName,
                      style: TextStyle(
                          color: Colors.white,
                          fontSize: 15.sp,
                          fontWeight: FontWeight.w700),
