...
PersonalSusuAccount personalSusuAccountFromJson(String str) => PersonalSusuAccount.fromJson(json.decode(str));

String personalSusuAccountToJson(PersonalSusuAccount data) => json.encode(data.toJson());

class PersonalSusuAccount {
  bool status;
  int code;
  String message;
  dynamic description;
  ...
  factory PersonalSusuAccount.fromJson(Map<String, dynamic> json) => PersonalSusuAccount(
    status: json["status"],
    code: json["code"],
