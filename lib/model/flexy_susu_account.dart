...
FlexySusuAccount flexySusuAccountFromJson(String str) => FlexySusuAccount.fromJson(json.decode(str));

String flexySusuAccountToJson(FlexySusuAccount data) => json.encode(data.toJson());

class FlexySusuAccount {
  bool status;
  int code;
  String message;
  dynamic description;
  ...
  factory FlexySusuAccount.fromJson(Map<String, dynamic> json) => FlexySusuAccount(
    status: json["status"],
    code: json["code"],
