...
GoalGetterSusuAccount goalGetterSusuAccountFromJson(String str) => GoalGetterSusuAccount.fromJson(json.decode(str));

String goalGetterSusuAccountToJson(GoalGetterSusuAccount data) => json.encode(data.toJson());

class GoalGetterSusuAccount {
  bool status;
  int code;
  String message;
  dynamic description;
  ...
  factory GoalGetterSusuAccount.fromJson(Map<String, dynamic> json) => GoalGetterSusuAccount(
    status: json["status"],
    code: json["code"],
