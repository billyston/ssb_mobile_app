...
/* class ArrowPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(
        size.width * 0.90, size.height * 0.30, size.width * 0.62,
        size.height * 0.36);
    path.quadraticBezierTo(
        size.width * 0.25, size.height * 0.45, size.width * 0.18,
        size.height * 0.70);
    path.moveTo(size.width * 0.09, size.height * 0.67);
    path.quadraticBezierTo(
        size.width * 0.14, size.height * 0.68, size.width * 0.17,
        size.height * 0.75);
    path.quadraticBezierTo(
        size.width * 0.22, size.height * 0.68, size.width * 0.28,
        size.height * 0.67);
...
class ArrowPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    {
     /* Path path = Path();
      path.moveTo(size.width * 0.25, 15);
      path.relativeCubicTo(0, 200, size.width * 0.25, 100, size.width * 0.5, 0);
      path = ArrowPath.addTip(path);

      canvas.drawPath(path, paint..color = buttonColor); */

        Path path = Path();
        path.moveTo(size.width * 0.25, 5);
        //path.relativeCubicTo(0, 0, 0, 90, 50, 50);
        path.quadraticBezierTo(20, 70, -50, 120);
